...
class GenSimQMD(qi.FiniteOutcomeModel):
    r"""
    ...
    def __init__(self, oplist, modelparams, probecounter, true_oplist = None, trueparams = None, probelist = None, min_freq=0, solver='scipy', trotter=False, IQLE=True):
        ...
        super(GenSimQMD, self).__init__(self._oplist)
    ...
    def likelihood(self, outcomes, modelparams, expparams):
        ...
        super(GenSimQMD, self).likelihood(
        ...
        if (self._solver == 'scipy'):
            ...
            pr0[:, :] = pr0fromScipyNC(t, modelparams[:,], np.array([expparams.item(0)[1:]]), self._oplist, probestate, Hp=self._trueHam, trotterize=self._trotter, IQLE=self._IQLE)
        else:
