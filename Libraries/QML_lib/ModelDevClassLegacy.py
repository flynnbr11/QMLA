"""
This file was called QMD previously. 
All functionality it offers should now be available in the current QMD file/class; this is retained in case something relies on it, but should be deleted later. 
"""
