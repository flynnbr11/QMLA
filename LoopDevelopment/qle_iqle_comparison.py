## This script uses the QMD class as of 20/12/17 to compare IQLE and QLE.
## Most recent version of class is in QMD_Class_Development.ipynb
...
plt.savefig('test_plots/iqle_errors_histogram_'+str(num_exp)+'_exp_'+str(num_part)+'_particles_'+str(num_tests)+'_runs.png')
plt.plot()    
...
plt.savefig('test_plots/iqle_final_quad_loss_histogram_'+str(num_exp)+'_exp_'+str(num_part)+'_particles_'+str(num_tests)+'_runs.png')
plt.plot()    
...
plt.clf()
for i in range(num_tests):
    plt.semilogy( range(1, 1+len(iqle_qlosses[i])), list(iqle_qlosses[i]))
plt.xlabel('Experiment Number');
plt.ylabel('Quadratic Loss');
plt.title('IQLE Quadratic Loss per experiment (single parameter, '+str(num_tests)+' runs)');
plt.savefig('test_plots/iqle_scatter_'+str(num_exp)+'_exp_'+str(num_part)+'_particles_'+str(num_tests)+'_runs.png')
plt.plot()    
...
if just_iqle is not True:    
    ...
    plt.savefig('test_plots/qle_errors_histogram_'+str(num_exp)+'_exp_'+str(num_part)+'_particles_'+str(num_tests)+'_runs.png')
    plt.plot()    
    ...
    plt.savefig('test_plots/qle_final_quad_loss_histogram_'+str(num_exp)+'_exp_'+str(num_part)+'_particles_'+str(num_tests)+'_runs.png')
    plt.plot()    
    ...
    plt.savefig('test_plots/qle_scatter_'+str(num_exp)+'_exp_'+str(num_part)+'_particles_'+str(num_tests)+'_runs.png')
    plt.plot()    
