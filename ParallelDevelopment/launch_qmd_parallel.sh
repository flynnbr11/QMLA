#!/bin/bash
#PBS -l nodes=2:ppn=2,walltime=00:20:00
...
python3 Exp.py -rq=1 -p=300 -e=75 -bt=30 -qid=$QMD_ID -pkl=0 -host=$SERVER_HOST
...
echo "QMD $QMD_ID Finished; end of script" 
