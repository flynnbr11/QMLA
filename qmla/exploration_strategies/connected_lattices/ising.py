...
class IsingProbabilistic(connected_lattice.ConnectedLattice):
    def __init__(self, exploration_rules, **kwargs):
        ...
        self.tree_completed_initially = False
        self.setup_exploration_class()  # from ConnectedLattice, using updated params


class IsingPredetermined(IsingProbabilistic):
    def __init__(self, exploration_rules, **kwargs):
        super().__init__(exploration_rules=exploration_rules, **kwargs)
...
class IsingSharedField(IsingPredetermined):
    def __init__(self, exploration_rules, **kwargs):
        super().__init__(exploration_rules=exploration_rules, **kwargs)
...
class TestReducedParticlesBayesFactors(IsingPredetermined):
    def __init__(self, exploration_rules, **kwargs):
        super().__init__(exploration_rules=exploration_rules, **kwargs)
        ...
        self.true_model = model_building_utilities.alph(self.initial_models[0])
        self.max_num_models_by_shape = {5: 2, "other": 0}


class TestAllParticlesBayesFactors(TestReducedParticlesBayesFactors):
    def __init__(self, exploration_rules, **kwargs):
        super().__init__(exploration_rules=exploration_rules, **kwargs)
