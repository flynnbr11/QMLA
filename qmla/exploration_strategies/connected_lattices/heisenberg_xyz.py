...
from qmla.exploration_strategies import (
    connected_lattice,
    connected_lattice_probabilistic,
)
...
class HeisenbergXYZProbabilistic(
    ...
    def __init__(self, exploration_rules, **kwargs):
        ...
        self.num_top_models_to_build_on = (
            1  # to test strict generation to ensure sensible paths occuring
        )
...
class HeisenbergXYZPredetermined(HeisenbergXYZProbabilistic):
    def __init__(self, exploration_rules, **kwargs):
        # print("[Exploration Strategies] init nv_spin_experiment_full_tree")
        super().__init__(exploration_rules=exploration_rules, **kwargs)
        ...
        self.max_num_models_by_shape = {2: 6, 3: 6, 4: 6, "other": 0}


class HeisenbergSharedField(HeisenbergXYZPredetermined):
    def __init__(self, exploration_rules, **kwargs):
        # print("[Exploration Strategies] init nv_spin_experiment_full_tree")
        super().__init__(exploration_rules=exploration_rules, **kwargs)
