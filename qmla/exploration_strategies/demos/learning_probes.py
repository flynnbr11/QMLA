...
class DemoProbes(exploration_strategy.ExplorationStrategy):
...
class DemoProbesTomographic(DemoProbes):
    def __init__(self, exploration_rules, **kwargs):
...
class DemoProbesPlus(DemoProbes):
    def __init__(self, exploration_rules, **kwargs):
...
class DemoProbesZero(DemoProbes):
    def __init__(self, exploration_rules, **kwargs):

        super().__init__(exploration_rules=exploration_rules, **kwargs)
        self.system_probes_generation_subroutine = (
            qmla.shared_functionality.probe_set_generation.zero_state_probes
        )
