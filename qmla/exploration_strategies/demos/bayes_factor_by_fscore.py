...
class DemoBayesFactorsByFscore(GeneticAlgorithmQMLAFullyConnectedLikewisePauliTerms):
    r"""
...
class DemoFractionalResourcesBayesFactorsByFscore(DemoBayesFactorsByFscore):
    def __init__(self, exploration_rules, true_model=None, **kwargs):
...
class DemoBayesFactorsByFscoreEloGraphs(DemoBayesFactorsByFscore):
    def __init__(self, exploration_rules, true_model=None, **kwargs):
