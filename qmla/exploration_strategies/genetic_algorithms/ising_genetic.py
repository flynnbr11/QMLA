...
class IsingGenetic(GeneticAlgorithmQMLAFullyConnectedLikewisePauliTerms):
    def __init__(self, exploration_rules, true_model=None, **kwargs):
        ...
        self.num_processes_to_parallelise_over = min(
            2 * len(self.initial_models) + 1, 16
        )
...
class IsingGeneticTest(IsingGenetic):
    def __init__(self, exploration_rules, true_model=None, **kwargs):
...
class IsingGeneticSingleLayer(IsingGenetic):
    def __init__(
