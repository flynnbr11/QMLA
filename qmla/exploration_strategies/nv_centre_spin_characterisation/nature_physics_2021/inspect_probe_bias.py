...
__all__ = ["InspectProbeBiasNVCentre"]


class InspectProbeBiasNVCentre(FullAccessNVCentre):
    def __init__(self, exploration_rules, **kwargs):
        ...
        self.system_probes_generation_subroutine = (
            qmla.shared_functionality.probe_set_generation.hahn_sequence_random_initial
        )
