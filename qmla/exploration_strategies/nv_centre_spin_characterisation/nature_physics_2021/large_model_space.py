...
class NVCentreGenticAlgorithmPrelearnedParameters(Genetic):
    r"""
    ...
    def __init__(self, exploration_rules, true_model=None, **kwargs):
        ...
        self.evaluation_probe_generation_subroutine = (
            qmla.shared_functionality.probe_set_generation.tomographic_basis
        )
    ...
    def _set_true_params(self):
        ...
        self._setup_available_terms_gali_model(
            n_qubits=self.n_qubits, available_axes=self.available_axes
        )
    ...
    def _get_secular_approx_true_params(
        ...
        nuclei_terms = {"x": 66e3, "y": 66e3, "z": 15e3}
        ...
        for n in range(2, 1 + num_qubits):
            coupling_term = "pauliSet_1J{n}_zJz_d{N}".format(n=n, N=total_num_qubits)
            ...
            for pauli in ["x", "y", "z"]:
                ...
                nuclei_rotation = "pauliSet_{n}_{p}_d{N}".format(
                    n=n, p=pauli, N=total_num_qubits
                )
    ...
    def generate_evaluation_data(self, num_times=100, **kwargs):
        r"""
...
class NVPrelearnedTest(NVCentreGenticAlgorithmPrelearnedParameters):
    def __init__(self, exploration_rules, true_model=None, **kwargs):
