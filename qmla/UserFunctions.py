...
default_true_operators_by_generator = {
    ...
    # 'NV_centre_spin_large_bath' : 'nv_spin_x_d1Pnv_spin_y_d1Pnv_spin_z_d1',
    # 'NV_centre_spin_large_bath' : 'nv_spin_x_d2PPnv_spin_y_d2PPnv_spin_z_d2',
    ...
    # 'two_qubit_ising_rotation_hyperfine_transverse' : 'xTiPPxTxPPyTi',
    # 6 params - full model # TODO reinstate -- testing whether alphetisation
    # of true model affects December/new code
...
model_generation_functions = {
    ...
    'PT_Effective_Hamiltonian':
        # ie NO spawning, just run first model
...
measurement_type = {
    ...
    # 'NV_centre_spin_large_bath' : 'hahn',
...
def get_probe_dict(
    ...
    print("[getProbeDict] Probe func used:",
          probe_dict_function)  # todo store in log file
    return probe_dict
