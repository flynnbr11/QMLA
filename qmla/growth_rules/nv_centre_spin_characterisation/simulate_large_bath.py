    ...
    def __init__(
        ...
        **kwargs
        ...
        self.gaussian_prior_means_and_widths = {
            ...
            # 'pauliSet_1_x_d3' : (B*g*bohr_magneton/hbar - 1.1e9, 2e9), # ~1.943 GHz
            # 'pauliSet_1_y_d3' : (B*g*bohr_magneton/hbar + 0..9e9, 2e9),
            # 'pauliSet_1_z_d3' : (B*g*bohr_magneton/hbar + 1.2e9, 2e9),
            # spin
