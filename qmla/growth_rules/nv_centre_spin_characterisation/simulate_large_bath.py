    ...
    def __init__(
        ...
        **kwargs
        ...
        self.gaussian_prior_means_and_widths = {
            ...
            'pauliSet_1_x_d3' : (B*g*bohr_magneton/hbar - 1.5e6, 2e6), # ~1.943 GHz
            'pauliSet_1_y_d3' : (B*g*bohr_magneton/hbar + 1.9e6, 2e6),
            'pauliSet_1_z_d3' : (B*g*bohr_magneton/hbar + 1.5e6, 2e6),
            # spin
