...
class GenSim_IQLE(qi.FiniteOutcomeModel):
    r"""
    ...
    def __init__(self, oplist, modelparams, probecounter, probelist = None, min_freq=0, solver='scipy', trotter=False):
        ...
        super(GenSim_IQLE, self).__init__(self._oplist)
    ...
    def likelihood(self, outcomes, modelparams, expparams):
        ...
        super(GenSim_IQLE, self).likelihood(
        ...
        if (self._solver == 'scipy'):
            ...
            pr0[:, :] = pr0fromScipyNC(t, modelparams[:,], np.array([expparams.item(0)[1:]]), self._oplist, probestate,trotterize=self._trotter)
        else:
